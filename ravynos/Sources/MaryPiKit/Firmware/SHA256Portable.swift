...
/// A small pure-Swift SHA-256 (FIPS 180-4) used where CryptoKit is not
/// available (Linux). Streaming: `update` as many times as needed, then `finalize`.
public struct SHA256Portable: Sendable {
