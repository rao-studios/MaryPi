...
MARY_TEST(turn_start_carries_the_plans_lanes_and_cues) {
    ...
    const char *lanes[] = { "personal", "behavioral" }, *entities[] = { "operates", "supports" };
    ...
    MARY_ASSERT_STR(mc_json_compact(mc_json_array(sewn, "lanes"), NULL), "[\"personal\",\"behavioral\"]");
    ...
    MARY_ASSERT_STR(mc_json_compact(mc_json_array(sewn, "lanes"), NULL), "[\"personal\"]");
