 ...
 * no family falls back to the longest matching pattern. */
...
#define THREAD_LANE_COUNT 4
extern const char *const thread_lanes[THREAD_LANE_COUNT];   /* personal, conversation, application, behavioral */
...
/* Whether `lane` is one of the four. */
