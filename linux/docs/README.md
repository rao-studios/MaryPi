# The MaryOS journey: from distro.conf to a login prompt on a Raspberry Pi 5
...
Raspberry Pi 5 and inside Apple's Virtualization.framework, and what is
Ubuntu's, what is MaryOS's and what is still missing. They were written while
...
| 3 | [Building from source](03-building-from-source.md) | The Docker builder, its three stages, caching, images without loop devices, the kernel extractor |
