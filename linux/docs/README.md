...
| 10 | [Mary](10-mary.md) | sewnd, threadd and maryd; how the key is kept; "Hey Mary", a typed turn, which lane runs; the ambient world; abilities and their policy; engines, recall and network activity; the units, the dev loop, what is missing |
| 11 | [The Thread](11-the-thread.md) | The hard drive is the memory: threadd and indexd, the record families and lanes, the graph, parity with the disk, threadctl, the Threads app |
